...
public class UpdateFeesDetails extends javax.swing.JFrame {
    ...
    public String updateData(){
        ...
        try{
            Connection con=DBConnection.getConnection();
            PreparedStatement ps=con.prepareStatement("update fees_details set student_name=?,roll_no=?,payment_mode=?,cheque_no=?,bank_name=?,dd_no=?,course_name=?,gstin=?,total_amount=?,date=?,amount=?,payable=?,balance=?,fees_status=?,cgst=?,sgst=?,total_in_words=?,remark=?,year1=?,year2=? where receipt_no=?");
            ...
            ps.setString(8, gstin);
            ps.setFloat(9, totalAmount);
            ps.setString(10, date);
            ps.setFloat(11, initialAmount);
            ps.setFloat(12, payable);
            ps.setFloat(13, balance);
            ps.setString(14, fees_status);
            ps.setFloat(15, cgst);
            ps.setFloat(16, sgst);
            ps.setString(17, totalInWords);
            ps.setString(18, remark);
            ps.setInt(19, year1);
            ps.setInt(20, year2);
            ps.setInt(21, receiptNo);
...
//            ResultSet rs=ps.getResultSet();
    ...
    public void setRecords(){
        try{
            ...
            date_datechooser.setDate(rs.getDate("date"));
    ...
    private void initComponents() {
        ...
        panel_parent.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(830, 40, 80, 40));
        ...
        panel_parent.add(date_datechooser, new org.netbeans.lib.awtextra.AbsoluteConstraints(900, 40, 160, 30));
        ...
        btn_print.setForeground(new java.awt.Color(255, 153, 255));
        btn_print.setText("Print");
        btn_print.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED, null, new java.awt.Color(255, 51, 255), null, null));
